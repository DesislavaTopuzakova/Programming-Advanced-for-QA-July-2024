...
public class ExceptionTests
{
    ...
    public void Test_CalculateDiscount_NegativeDiscount_ThrowsArgumentException()
    {
        ...
        Assert.AreEqual(result.Message, "Discount must be between 0 and 100. (Parameter 'discount')"); // Judge не проверява това
	}
    ...
    public void Test_CalculateDiscount_DiscountOver100_ThrowsArgumentException()
    {
        ...
        // Act & Assert
        Assert.That(() => _exceptions.ArgumentCalculateDiscount(finalPrice, discount), Throws.ArgumentException); // Прави същата проверка като долната
    ...
    public void Test_GetElement_IndexGreaterThanArrayLength_ThrowsIndexOutOfRangeException()
    {
        ...
        Assert.AreEqual(result.Message, "Index is out of range."); // Judge не проверява това
	}
